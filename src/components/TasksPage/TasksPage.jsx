...
function TasksPage() {
  ...
  function addTask() {
    ...
    for (var i = 0; i < tasks.length; i++) {
      if (tasks[i].name.toLowerCase() == newName.trim().toLowerCase()) {
        alert('Task name already exists'); return
      }
    }
  ...
  function saveEdit(id, name, status) {
    for (var i = 0; i < tasks.length; i++) {
      if (tasks[i].id != id && tasks[i].name.toLowerCase() == name.toLowerCase()) {
        alert('Task name already exists'); return false
      }
    }
    var updated = []
    for (var i = 0; i < tasks.length; i++) {
